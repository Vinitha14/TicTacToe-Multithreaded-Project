...
public final class TicTacToeClient extends JFrame implements Runnable {
	...
	Font f1 = new Font("Comic Sans MS",Font.ITALIC,18);
        ticTacToeHost = host; // set name of server
        displayArea = new JTextArea(4, 30); // set up JTextArea
        displayArea.setEditable(false);
	displayArea.setFont(f1);
	displayArea.setBackground(new Color(0x424949));
	displayArea.setForeground(new Color(0xffffdd));
	...
	idField.setPreferredSize(new Dimension(20,50));
	idField.setBackground(new Color(0x424949));
	Font f = new Font("Comic Sans MS",Font.BOLD,18);
	idField.setFont(f);
	//idField.setBackground(new Color(0xffffdd));
	idField.setForeground(new Color(0xffffdd));
        add(idField, BorderLayout.NORTH);

        panel2 = new JPanel(); // set up panel to contain boardPanel
        panel2.add(boardPanel, BorderLayout.CENTER); // add board panel
	panel2.setFont(f);
	panel2.setBackground(new Color(0x138d75));
        add(panel2, BorderLayout.CENTER); // add container panel

        setSize(600, 525); // set size of window
    ...
    private class Square extends JPanel {
        ...
        public Dimension getPreferredSize() {
            return new Dimension(90, 90); // return preferred size
        }
        ...
        public void paintComponent(Graphics g) {
            ...
            g.drawRect(0, 0, 89, 89); // draw square
		Font f = new Font("Comic Sans MS",Font.ITALIC,38);
		g.setFont(f);
	//g.setBackground(Color.BLUE);
	//g.setForeground(Color.RED);
            g.drawString(mark, 31, 60); // draw mark   
