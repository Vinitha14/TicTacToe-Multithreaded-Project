...
public class TicTacToeServer extends JFrame {
	...
	Font f = new Font("Comic Sans MS",Font.ITALIC,18);
	outputArea.setFont(f);
	//outputArea.setBackground(Color.BLUE);
	//outputArea.setBackground(new Color(0xfa8072));
	outputArea.setBackground(new Color(0xcd5c5c));
	outputArea.setForeground(new Color(0xffffdd));
    ...
    private class Player implements Runnable {
        ...
        public void otherPlayerMoved(int location) {
            ...
            output.format(hasWinner() ? "YOU LOOSE\n" : boardFilledUp() ? "TIE\n" : "");
            output.flush();
        }
            ...
            try {
                ...
                while (!isGameOver()) {
                    ...
                    if (validateAndMove(location, playerNumber)) {
                        ...
                        output.flush(); // flush output
                        output.format(hasWinner() ? "YOU WIN\n" : boardFilledUp() ? "TIE\n" : "");
                        output.flush();
                    } else {
                        // move was invalid
